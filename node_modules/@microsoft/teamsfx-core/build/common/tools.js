...
const constants_3 = require("./local/constants");
const projectSettingsHelper_1 = require("./projectSettingsHelper");
const existingTemplatesStat_1 = require("../plugins/resource/cicd/utils/existingTemplatesStat");
const environment_1 = require("../core/environment");
const errors_1 = require("../plugins/resource/cicd/errors");
...
function canAddSso(projectSettings, returnError = false) {
    ...
    if (projectSettingsHelper_1.isExistingTabApp(projectSettings) &&
        !(solutionSettings && solutionSettings.capabilities.includes(question_1.TabSsoItem.id))) {
    ...
    if (solutionSettings.capabilities.length === 1 &&
        solutionSettings.capabilities[0] === question_1.MessageExtensionItem.id) {
        return returnError
    ...
    if (solutionSettings.capabilities.includes(question_1.BotOptionItem.id) &&
        !(solutionSettings.capabilities.includes(question_1.TabOptionItem.id) &&
            !solutionSettings.capabilities.includes(question_1.TabSsoItem.id))) {
        const botHostType = (_b = (_a = projectSettings.pluginSettings) === null || _a === void 0 ? void 0 : _a[constants_1.ResourcePlugins.Bot]) === null || _b === void 0 ? void 0 : _b[constants_3.BotHostTypeName];
        if (botHostType === constants_3.BotHostTypes.AzureFunctions) {
            return returnError
    ...
    const containTabSsoItem = solutionSettings.capabilities.includes(question_1.TabSsoItem.id);
    const containTab = solutionSettings.capabilities.includes(question_1.TabOptionItem.id);
    const containBotSsoItem = solutionSettings.capabilities.includes(question_1.BotSsoItem.id);
    const containBot = solutionSettings.capabilities.includes(question_1.BotOptionItem.id);
