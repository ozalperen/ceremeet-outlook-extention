...
exports.isVSProject = exports.newProjectSettings = exports.getProjectSettingsVersion = exports.isExistingTabApp = exports.hasAzureResourceV3 = exports.hasAzureResource = exports.hasSPFx = exports.hasAAD = exports.isValidProject = exports.validateProjectSettings = void 0;
...
const resource_1 = require("../component/resource");
...
function hasAzureResourceV3(projectSetting, excludeAad = false) {
    const azureResources = [
        resource_1.ResourceComponentNames.apim,
        resource_1.ResourceComponentNames.webApp,
        resource_1.ResourceComponentNames.function,
        resource_1.ResourceComponentNames.identity,
        resource_1.ResourceComponentNames.keyVault,
        resource_1.ResourceComponentNames.sql,
        resource_1.ResourceComponentNames.storage,
    ];
    if (!excludeAad) {
        azureResources.push(resource_1.ResourceComponentNames.aad);
    }
