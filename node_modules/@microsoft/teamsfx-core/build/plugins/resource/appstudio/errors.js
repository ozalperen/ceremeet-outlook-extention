...
AppStudioError.FileNotFoundError = {
    ...
    message: (filePath) => [
        localizeUtils_1.getDefaultString("error.appstudio.fileNotFoundError", filePath),
        localizeUtils_1.getLocalizedString("error.appstudio.fileNotFoundError", filePath),
    ],
};
AppStudioError.NotADirectoryError = {
    name: "NotADirectory",
    message: (directoryPath) => [
        localizeUtils_1.getDefaultString("error.appstudio.notADirectoryError", directoryPath),
        localizeUtils_1.getLocalizedString("error.appstudio.notADirectoryError", directoryPath),
    ],
};
AppStudioError.RemoteAppIdCreateFailedError = {
    name: "RemoteAppIdCreateFailed",
    message: (error) => [
        localizeUtils_1.getDefaultString("error.appstudio.remoteTeamsAppCreateFailed", error === null || error === void 0 ? void 0 : error.name, error === null || error === void 0 ? void 0 : error.message),
        localizeUtils_1.getLocalizedString("error.appstudio.remoteTeamsAppCreateFailed", error === null || error === void 0 ? void 0 : error.name, error === null || error === void 0 ? void 0 : error.message),
    ],
};
AppStudioError.RemoteAppIdUpdateFailedError = {
    name: "RemoteAppIdUpdateFailed",
    message: (error) => [
        localizeUtils_1.getDefaultString("error.appstudio.remoteTeamsAppUpdateFailed", error === null || error === void 0 ? void 0 : error.name, error === null || error === void 0 ? void 0 : error.message),
        localizeUtils_1.getLocalizedString("error.appstudio.remoteTeamsAppUpdateFailed", error === null || error === void 0 ? void 0 : error.name, error === null || error === void 0 ? void 0 : error.message),
    ],
};
AppStudioError.LocalAppIdCreateFailedError = {
    name: "LocalAppIdCreateFailed",
    message: (error) => [
        localizeUtils_1.getDefaultString("error.appstudio.localTeamsAppCreateFailed", error === null || error === void 0 ? void 0 : error.name, error === null || error === void 0 ? void 0 : error.message),
        localizeUtils_1.getLocalizedString("error.appstudio.localTeamsAppCreateFailed", error === null || error === void 0 ? void 0 : error.name, error === null || error === void 0 ? void 0 : error.message),
    ],
};
AppStudioError.LocalAppIdUpdateFailedError = {
    name: "LocalAppIdUpdateFailed",
    message: (error) => [
        localizeUtils_1.getDefaultString("error.appstudio.localTeamsAppUpdateFailed", error === null || error === void 0 ? void 0 : error.name, error === null || error === void 0 ? void 0 : error.message),
        localizeUtils_1.getLocalizedString("error.appstudio.localTeamsAppUpdateFailed", error === null || error === void 0 ? void 0 : error.name, error === null || error === void 0 ? void 0 : error.message),
    ],
};
AppStudioError.TeamsAppCreateFailedError = {
    name: "TeamsAppCreateFailed",
    message: (error) => [
        localizeUtils_1.getDefaultString("error.appstudio.teamsAppCreateFailed", error === null || error === void 0 ? void 0 : error.name, error === null || error === void 0 ? void 0 : error.message),
        localizeUtils_1.getLocalizedString("error.appstudio.teamsAppCreateFailed", error === null || error === void 0 ? void 0 : error.name, error === null || error === void 0 ? void 0 : error.message),
    ],
};
AppStudioError.TeamsAppUpdateFailedError = {
    name: "TeamsAppUpdateFailed",
    message: (teamsAppId) => [
        localizeUtils_1.getDefaultString("error.appstudio.teamsAppUpdateFailed", teamsAppId),
        localizeUtils_1.getLocalizedString("error.appstudio.teamsAppUpdateFailed", teamsAppId),
    ],
};
AppStudioError.TeamsAppNotFoundError = {
    name: "TeamsAppNotFound",
    message: (appId) => [
        localizeUtils_1.getDefaultString("error.appstudio.teamsAppNotFound", appId),
        localizeUtils_1.getLocalizedString("error.appstudio.teamsAppNotFound", appId),
    ],
};
AppStudioError.InvalidManifestError = {
    name: "InvalidManifest",
    message: (error, key) => [
        localizeUtils_1.getDefaultString("error.appstudio.invalidManifest", error, key),
        localizeUtils_1.getLocalizedString("error.appstudio.invalidManifest", error, key),
    ],
};
AppStudioError.ManifestLoadFailedError = {
    name: "ManifestLoadFailed",
    message: (error) => [
        localizeUtils_1.getDefaultString("error.appstudio.loadManifest", error),
        localizeUtils_1.getLocalizedString("error.appstudio.loadManifest", error),
    ],
};
...
AppStudioError.GetLocalDebugConfigFailedError = {
    ...
    message: (error) => [
        localizeUtils_1.getDefaultString("error.appstudio.getLocalConfigFailed", error.message),
        localizeUtils_1.getLocalizedString("error.appstudio.getLocalConfigFailed", error.message),
    ],
};
AppStudioError.GetRemoteConfigFailedError = {
    name: "GetRemoteConfigFailed",
    message: (errorMessage, isProvisionSucceeded) => [
        localizeUtils_1.getDefaultString("error.appstudio.getRemoteConfigFailed", errorMessage) +
            `${isProvisionSucceeded ? "" : localizeUtils_1.getDefaultString("plugins.appstudio.provisionTip")}`,
        localizeUtils_1.getLocalizedString("error.appstudio.getRemoteConfigFailed", errorMessage) +
            `${isProvisionSucceeded ? "" : localizeUtils_1.getLocalizedString("plugins.appstudio.provisionTip")}`,
    ],
};
AppStudioError.TeamsAppPublishFailedError = {
    name: "TeamsAppPublishFailed",
    message: (teamsAppId, correlationId) => [
...
AppStudioError.TeamsAppPublishCancelError = {
    ...
    message: (name) => [
        localizeUtils_1.getDefaultString("error.appstudio.publishCancelled", name),
        localizeUtils_1.getLocalizedString("error.appstudio.publishCancelled", name),
    ],
};
...
AppStudioError.ScaffoldFailedError = {
    ...
    message: (error) => {
        var _a, _b;
        return [
            (_a = error.message) !== null && _a !== void 0 ? _a : localizeUtils_1.getDefaultString("error.appstudio.scaffoldFailed"),
            (_b = error.displayMessage) !== null && _b !== void 0 ? _b : localizeUtils_1.getLocalizedString("error.appstudio.scaffoldFailed"),
        ];
    },
};
...
AppStudioError.UpdateManifestCancelError = {
    ...
    message: (name) => [
        localizeUtils_1.getDefaultString("error.appstudio.updateManifestCancelled", name),
        localizeUtils_1.getLocalizedString("error.appstudio.updateManifestCancelled", name),
    ],
};
