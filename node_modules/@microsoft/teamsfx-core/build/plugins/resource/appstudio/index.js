    ...
    async buildTeamsPackage(ctx, isLocalDebug) {
        ...
        try {
            ...
            if (((_a = ctx.answers) === null || _a === void 0 ? void 0 : _a.platform) === teamsfx_api_1.Platform.CLI || ((_b = ctx.answers) === null || _b === void 0 ? void 0 : _b.platform) === teamsfx_api_1.Platform.VS) {
                ...
                (_c = ctx.ui) === null || _c === void 0 ? void 0 : _c.showMessage("info", builtSuccess, false);
            }
            else {
                ...
                const builtSuccess = localizeUtils_1.getLocalizedString("plugins.appstudio.buildSucceedNotice", appPackageLink);
                (_d = ctx.ui) === null || _d === void 0 ? void 0 : _d.showMessage("info", builtSuccess, false);
            }
