...
class SimpleAuthPluginImpl {
    async localDebug(ctx) {
        ...
        if (tools_1.isConfigUnifyEnabled()) {
            ...
            (_c = (_b = ctx.localSettings) === null || _b === void 0 ? void 0 : _b.auth) === null || _c === void 0 ? void 0 : _c.set(localSettingsConstants_1.LocalSettingsSimpleAuthKeys.SimpleAuthFilePath, simpleAuthFilePath);
        }
    ...
    async postLocalDebug(ctx) {
        ...
        let configs;
        if (tools_1.isConfigUnifyEnabled()) {
            configs = common_1.Utils.getWebAppConfig(ctx, false);
        }
        else {
            configs = common_1.Utils.getWebAppConfig(ctx, true);
        }
        const configArray = [];
        ...
        if (tools_1.isConfigUnifyEnabled()) {
            ...
            (_c = (_b = ctx.localSettings) === null || _b === void 0 ? void 0 : _b.auth) === null || _c === void 0 ? void 0 : _c.set(localSettingsConstants_1.LocalSettingsSimpleAuthKeys.SimpleAuthEnvironmentVariableParams, configArray.join(" "));
        }
    ...
    async initWebAppClient(ctx) {
        ...
        const webAppName = common_1.Utils.generateResourceName(ctx.projectSettings.appName, resourceNameSuffix);
