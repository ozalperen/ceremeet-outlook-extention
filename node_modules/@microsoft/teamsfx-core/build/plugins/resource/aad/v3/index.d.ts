...
export declare class AadAppForTeamsPluginV3 implements v3.PluginV3 {
    ...
    checkPermission(ctx: v2.Context, envInfo: v3.EnvInfoV3, tokenProvider: TokenProviderInAPI, userInfo: IUserList): Promise<Result<ResourcePermission[], FxError>>;
    grantPermission(ctx: v2.Context, envInfo: v3.EnvInfoV3, tokenProvider: TokenProviderInAPI, userInfo: IUserList): Promise<Result<ResourcePermission[], FxError>>;
}
