...
export declare class AadAppClient {
    ...
    static getAadAppUsingManifest(stage: string, objectId: string, clientSecret: string | undefined, oauth2PermissionScopeId: string | undefined, graphTokenProvider?: GraphTokenProvider, envName?: string): Promise<ProvisionConfig>;
