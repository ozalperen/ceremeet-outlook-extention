...
class FrontendPluginImpl {
    ...
    async localDebug(ctx) {
        ...
        if (tools_1.isConfigUnifyEnabled()) {
            ...
            (_c = (_b = ctx.localSettings) === null || _b === void 0 ? void 0 : _b.frontend) === null || _c === void 0 ? void 0 : _c.set(localSettingsConstants_1.LocalSettingsFrontendKeys.TabIndexPath, constants_1.Constants.FrontendIndexPath);
        }
        return teamsfx_api_1.ok(undefined);
    }
