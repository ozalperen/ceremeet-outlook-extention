...
class DotnetPluginImpl {
    ...
    async scaffold(ctx) {
        ...
        await scaffold_1.scaffoldFromZipPackage(ctx.root, new templateInfo_1.TemplateInfo({ ProjectName: projectName }));
        ctx.projectSettings.pluginSettings = Object.assign(Object.assign({}, (_a = ctx.projectSettings) === null || _a === void 0 ? void 0 : _a.pluginSettings), { projectFilePath: path_1.default.join(ctx.root, constants_1.DotnetPathInfo.projectFilename(ctx.projectSettings.appName)) });
