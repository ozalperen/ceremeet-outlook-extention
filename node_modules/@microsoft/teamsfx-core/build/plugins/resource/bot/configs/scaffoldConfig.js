...
class ScaffoldConfig {
    ...
    async restoreConfigFromContext(context, isScaffold) {
        ...
        if (Array.isArray(rawHostTypeTriggers)) {
            ...
            this.triggers = rawHostTypeTriggers
                .map((hostTypeTrigger) => {
                const option = question_1.HostTypeTriggerOptions.find((option) => option.id === hostTypeTrigger);
    ...
    static getHostTypeFromHostTypeTriggerQuestion(answers) {
        ...
        if (Array.isArray(hostTypeTriggers)) {
            const hostTypes = hostTypeTriggers.map((item) => { var _a; return (_a = question_1.HostTypeTriggerOptions.find((option) => option.id === item)) === null || _a === void 0 ? void 0 : _a.hostType; });
    ...
    static getHostTypeFromProjectSettings(context) {
        ...
        return utils.convertToConstValues(rawHostType, strings_1.HostTypes);
    }
