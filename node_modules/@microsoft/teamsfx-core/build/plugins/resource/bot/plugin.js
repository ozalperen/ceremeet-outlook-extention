...
class TeamsBotImpl {
    ...
    async updateMessageEndpointOnAppStudio(endpoint) {
        ...
        errors_1.checkAndThrowIfMissing(strings_1.ConfigNames.LOCAL_BOT_ID, common_1.isConfigUnifyEnabled()
        ...
        const botReg = {
            botId: common_1.isConfigUnifyEnabled()
    ...
    async createNewBotRegistrationOnAppStudio() {
        ...
        else if (common_1.isConfigUnifyEnabled() &&
