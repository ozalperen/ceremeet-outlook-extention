    ...
    async deploy(ctx, inputs, tokenProvider) {
        ...
        try {
            ...
            if (appCatalogSite) {
                ...
                const res = await ((_b = ctx.userInteraction) === null || _b === void 0 ? void 0 : _b.showMessage("warn", localizeUtils_1.getLocalizedString("plugins.spfx.createAppCatalogNotice", tenant.value), true, "OK", constants_2.Constants.READ_MORE));
            ...
            try {
                ...
                if (((_f = e.response) === null || _f === void 0 ? void 0 : _f.status) === 403) {
                    (_g = ctx.userInteraction) === null || _g === void 0 ? void 0 : _g.showMessage("error", localizeUtils_1.getLocalizedString("plugins.spfx.deployFailedNotice", appCatalogSite), false, "OK");
