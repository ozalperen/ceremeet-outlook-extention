...
exports.DependencyInstallError = exports.DependencyValidateError = exports.NpmInstallError = exports.NpmNotFoundError = exports.UploadAppPackageFailedError = exports.GetTenantFailedError = exports.CreateAppCatalogFailedError = exports.InsufficientPermissionError = exports.GetGraphTokenFailedError = exports.GetSPOTokenFailedError = exports.NoManifestFileError = exports.BuildSPPackageError = exports.NoSPPackageError = exports.ScaffoldError = void 0;
...
function NpmNotFoundError() {
    return new teamsfx_api_1.SystemError(constants_1.Constants.PLUGIN_NAME, "NpmNotFound", localizeUtils_1.getDefaultString("plugins.spfx.error.npmNotFound"), localizeUtils_1.getLocalizedString("plugins.spfx.error.npmNotFound"));
}
