...
let TeamsAppSolution = class TeamsAppSolution {
    constructor() {
        ...
        this.CICDPlugin = typedi_1.Container.get(ResourcePluginContainer_1.ResourcePluginsV2.CICDPlugin);
    ...
    async provision(ctx) {
        ...
        try {
            ...
            if (provisionResult.isOk()) {
                ...
                const msg = localizeUtils_1.getLocalizedString("core.provision.successNotice", (_f = ctx.projectSettings) === null || _f === void 0 ? void 0 : _f.appName);
                ...
                if (!this.isAzureProject(ctx) && tools_1.isMultiEnvEnabled()) {
                    ...
                    (_m = ctx.envInfo.state
                        .get(constants_2.GLOBAL_CONFIG)) === null || _m === void 0 ? void 0 : _m.set(constants_2.REMOTE_TEAMS_APP_TENANT_ID, appStudioTokenJson.tid);
                }
            }
            else {
                if (!tools_1.isUserCancelError(provisionResult.error) &&
                    !tools_1.isCheckAccountError(provisionResult.error)) {
                    const msg = localizeUtils_1.getLocalizedString("core.provision.failNotice", (_o = ctx.projectSettings) === null || _o === void 0 ? void 0 : _o.appName);
    ...
    async deploy(ctx) {
        ...
        try {
            if (this.isAzureProject(ctx)) {
                ...
                // causes 2 M365 logins before the token caching in common lib takes effect.
                const appStudioTokenJson = await ((_c = ctx.appStudioToken) === null || _c === void 0 ? void 0 : _c.getJsonObject());
            ...
            if (result.isOk()) {
                if (this.isAzureProject(ctx)) {
                    const msg = localizeUtils_1.getLocalizedString("core.deploy.successNotice", (_d = ctx.projectSettings) === null || _d === void 0 ? void 0 : _d.appName);
                    (_e = ctx.logProvider) === null || _e === void 0 ? void 0 : _e.info(msg);
                    (_f = ctx.ui) === null || _f === void 0 ? void 0 : _f.showMessage("info", msg, false);
                }
            }
            else {
                const msg = localizeUtils_1.getLocalizedString("core.deploy.failNotice", (_g = ctx.projectSettings) === null || _g === void 0 ? void 0 : _g.appName);
                (_h = ctx.logProvider) === null || _h === void 0 ? void 0 : _h.info(msg);
            }
            return result;
        }
        finally {
    ...
    async doLocalDebug(ctx) {
        ...
        try {
            ...
            const localDebugTenantId = tools_1.isMultiEnvEnabled()
                ...
                : (_d = ctx.envInfo.state.get(constants_2.PluginNames.AAD)) === null || _d === void 0 ? void 0 : _d.get(constants_2.LOCAL_TENANT_ID);
...
async function askForProvisionConsent(ctx) {
    ...
    const msg = localizeUtils_1.getLocalizedString("core.provision.confirmNotice", username, subscriptionName ? subscriptionName : subscriptionId);
    let confirmRes = undefined;
    if (tools_1.isMultiEnvEnabled()) {
        const msgNew = localizeUtils_1.getLocalizedString("core.provision.confirmEnvNotice", ctx.envInfo.envName, username, subscriptionName ? subscriptionName : subscriptionId);
