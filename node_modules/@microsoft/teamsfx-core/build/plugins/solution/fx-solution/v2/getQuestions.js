...
exports.getQuestionsForAddFeature = exports.getQuestionsForAddResource = exports.getQuestionsForAddCapability = exports.getQuestionsForUserTask = exports.getQuestions = exports.getTabScaffoldQuestionsV2 = exports.getQuestionsForScaffoldingPreview = exports.getQuestionsForScaffolding = void 0;
...
async function getQuestionsForAddFeature(ctx, inputs, func, envInfo, tokenProvider) {
    ...
    if (canAddCapabilityResult.isErr() && canAddResourceResult.isErr()) {
        return teamsfx_api_1.err(canAddCapabilityResult.error);
    }
    // check and generate additional feature options
    if (tools_1.canAddSso(ctx.projectSetting)) {
