...
async function checkPermissionImpl(param, envState, envName, telemetryReporter, ui, graphTokenProvider, logProvider, platform) {
    ...
    let errorMsg = "";
    if (errors.length > 0) {
        errorMsg += localizeUtils_1.getLocalizedString("core.collaboration.FailedToCheckPermission");
    ...
    if (errorMsg) {
        return teamsfx_api_1.err(util_1.sendErrorTelemetryThenReturnError(constants_1.SolutionTelemetryEvent.CheckPermission, new teamsfx_api_1.UserError(constants_1.SolutionSource, constants_1.SolutionError.FailedToCheckPermission, errorMsg), telemetryReporter));
    }
