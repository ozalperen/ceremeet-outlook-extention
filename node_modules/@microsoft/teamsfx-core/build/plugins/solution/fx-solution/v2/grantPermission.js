...
async function grantPermissionImpl(param, envState, envName, telemetryReporter, ui, graphTokenProvider, logProvider, platform, email) {
    ...
    const progressBar = ui === null || ui === void 0 ? void 0 : ui.createProgressBar(localizeUtils_1.getLocalizedString("core.collaboration.GrantingPermission"), 1);
    try {
        ...
        if (!email || email === result.value.userPrincipalName) {
            return teamsfx_api_1.err(util_1.sendErrorTelemetryThenReturnError(constants_1.SolutionTelemetryEvent.GrantPermission, new teamsfx_api_1.UserError(constants_1.SolutionSource, constants_1.SolutionError.EmailCannotBeEmptyOrSame, localizeUtils_1.getDefaultString("core.collaboration.EmailCannotBeEmptyOrSame"), localizeUtils_1.getLocalizedString("core.collaboration.EmailCannotBeEmptyOrSame")), telemetryReporter));
        }
        const userInfo = await collaborationUtil_1.CollaborationUtil.getUserInfo(graphTokenProvider, email);
        if (!userInfo) {
            return teamsfx_api_1.err(util_1.sendErrorTelemetryThenReturnError(constants_1.SolutionTelemetryEvent.GrantPermission, new teamsfx_api_1.UserError(constants_1.SolutionSource, constants_1.SolutionError.CannotFindUserInCurrentTenant, localizeUtils_1.getDefaultString("core.collaboration.CannotFindUserInCurrentTenant"), localizeUtils_1.getLocalizedString("core.collaboration.CannotFindUserInCurrentTenant")), telemetryReporter));
        }
        ...
        if (platform === teamsfx_api_1.Platform.CLI) {
            ...
            if (!envName) {
                return teamsfx_api_1.err(util_1.sendErrorTelemetryThenReturnError(constants_1.SolutionTelemetryEvent.GrantPermission, new teamsfx_api_1.SystemError(constants_1.SolutionSource, constants_1.SolutionError.FailedToGetEnvName, localizeUtils_1.getDefaultString("core.collaboration.FailedToGetEnvName"), localizeUtils_1.getLocalizedString("core.collaboration.FailedToGetEnvName")), telemetryReporter));
            }
            const message = [
                {
        ...
        let errorMsg = "";
        if (errors.length > 0) {
            errorMsg += localizeUtils_1.getLocalizedString("core.collaboration.FailedToGrantPermission", email);
        ...
        if (platform === teamsfx_api_1.Platform.CLI) {
            ...
            if (collaborationUtil_1.CollaborationUtil.isSpfxProject(param.ctx)) {
                ui === null || ui === void 0 ? void 0 : ui.showMessage("info", localizeUtils_1.getLocalizedString("core.collaboration.SharePointTip") +
                    constants_1.SharePointManageSiteAdminHelpLink, false);
            }
            else {
                ui === null || ui === void 0 ? void 0 : ui.showMessage("info", localizeUtils_1.getLocalizedString("core.collaboration.AzureTip") + constants_1.AzureRoleAssignmentsHelpLink, false);
            }
            if (errorMsg) {
        ...
        if (errorMsg) {
            return teamsfx_api_1.err(util_1.sendErrorTelemetryThenReturnError(constants_1.SolutionTelemetryEvent.GrantPermission, new teamsfx_api_1.UserError(constants_1.SolutionSource, constants_1.SolutionError.FailedToGrantPermission, errorMsg), telemetryReporter));
        }
