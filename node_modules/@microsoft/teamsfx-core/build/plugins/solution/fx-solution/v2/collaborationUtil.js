...
class CollaborationUtil {
    static async getCurrentUserInfo(graphTokenProvider) {
    ...
    static async getUserInfo(graphTokenProvider, email) {
        const currentUser = await (graphTokenProvider === null || graphTokenProvider === void 0 ? void 0 : graphTokenProvider.getJsonObject());
        if (!currentUser) {
            return undefined;
        }
        ...
        if (email) {
            const graphToken = await (graphTokenProvider === null || graphTokenProvider === void 0 ? void 0 : graphTokenProvider.getAccessToken());
