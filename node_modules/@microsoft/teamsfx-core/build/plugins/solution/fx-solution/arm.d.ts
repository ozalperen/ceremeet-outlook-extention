...
export declare function doDeployArmTemplatesV3(ctx: v2.Context, inputs: v2.InputsWithProjectPath, envInfo: v3.EnvInfoV3, azureAccountProvider: AzureAccountProvider): Promise<Result<void, FxError>>;
export declare function deployArmTemplates(ctx: SolutionContext): Promise<Result<void, FxError>>;
export declare function deployArmTemplatesV3(ctx: v2.Context, inputs: v2.InputsWithProjectPath, envInfo: v3.EnvInfoV3, azureAccountProvider: AzureAccountProvider): Promise<Result<void, FxError>>;
...
declare class Arm {
    ...
    deployArmTemplates(ctx: v2.Context, inputs: v2.InputsWithProjectPath, envInfo: v3.EnvInfoV3, azureAccountProvider: AzureAccountProvider): Promise<Result<void, FxError>>;
}
