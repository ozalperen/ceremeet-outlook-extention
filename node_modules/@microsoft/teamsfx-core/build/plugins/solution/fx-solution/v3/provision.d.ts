import { AppStudioTokenProvider, AzureAccountProvider, FxError, Json, QTreeNode, Result, TokenProvider, v2, v3, Void } from "@microsoft/teamsfx-api";
 ...
 *
 */
export declare function fillInAzureConfigs(ctx: v2.Context, inputs: v2.InputsWithProjectPath, envInfo: v3.EnvInfoV3, tokenProvider: TokenProvider): Promise<Result<Void, FxError>>;
