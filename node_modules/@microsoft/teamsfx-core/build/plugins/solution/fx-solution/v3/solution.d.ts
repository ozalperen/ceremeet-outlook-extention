import { AppStudioTokenProvider, Func, FxError, Inputs, Json, Result, TokenProvider, v2, v3, Void } from "@microsoft/teamsfx-api";
...
export declare class TeamsFxAzureSolution implements v3.ISolution {
    ...
    publishApplication(ctx: v2.Context, inputs: v2.InputsWithProjectPath, envInfo: v2.DeepReadonly<v3.EnvInfoV3>, tokenProvider: AppStudioTokenProvider, telemetryProps?: Json): Promise<Result<Void, FxError>>;
