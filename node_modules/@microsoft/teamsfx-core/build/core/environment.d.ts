import { CryptoProvider, EnvConfig, FxError, Result, EnvInfo, Json, v3, Void } from "@microsoft/teamsfx-api";
...
declare class EnvironmentManager {
    ...
    createLocalEnv(projectPath: string): Promise<Result<Void, FxError>>;
