...
function createCapabilityForDotNet() {
    const staticOptions = [question_1.TabOptionItem, question_1.BotOptionItem];
    return {
        name: CoreQuestionNames.Capabilities,
