...
const constants_2 = require("../../plugins/solution/fx-solution/v2/constants");
/**
...
async function getQuestionsForCreateProjectWithDotNet(inputs) {
    ...
    dotnetNode.addChild(new teamsfx_api_1.QTreeNode(question_2.ProgrammingLanguageQuestionForDotNet));
    inputs[question_1.AzureSolutionQuestionNames.Solution] = constants_2.TeamsAppSolutionNameV2;
    // only CLI need folder input
