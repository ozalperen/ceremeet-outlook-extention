...
async function migrate(ctx) {
    ...
    try {
        ...
        const requiredResourceAccess = MigrationUtils_1.permissionsToRequiredResourceAccess(permissions);
        ...
        await generateAadManifestTemplate_1.generateAadManifestTemplate(inputs.projectPath, projectSettingsJson, requiredResourceAccess, true);
